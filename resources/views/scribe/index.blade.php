...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "http://star-test.test";
        var useCsrf = Boolean();
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-login">Login API for users.</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="transaction">
                    <a href="#transaction">Transaction</a>
                                    ...
                                    <ul id="tocify-subheader-transaction" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="transaction-GETapi-transactions--id-">
                                <a href="#transaction-GETapi-transactions--id-">View transaction status.</a>
                            </li>
                                                                        </ul>
                            </ul>
                    <ul id="tocify-header-transfer" class="tocify-header">
                <li class="tocify-item level-1" data-unique="transfer">
                    <a href="#transfer">Transfer</a>
                </li>
                                    <ul id="tocify-subheader-transfer" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="transfer-POSTapi-transfer">
                                <a href="#transfer-POSTapi-transfer">Transfer money between users.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: February 20, 2025</li>
    </ul>
</div>
...
<aside>
    <strong>Base URL</strong>: <code>http://star-test.test</code>
</aside>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="auth">Auth</h1>
                                ...
                                <h2 id="auth-POSTapi-login">Login API for users.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The recipient's user ID. Example: <code>abc123@gmail.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Password of user. Example: <code>abc123</code></p>
        </div>
        </form>
                ...
                <h1 id="transaction">Transaction</h1>
                                ...
                                <h2 id="transaction-GETapi-transactions--id-">View transaction status.</h2>
...
<div class="bash-example">
    ...
    --get "http://star-test.test/api/transactions/17" \
    --header "Content-Type: application/json" \
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://star-test.test/api/transactions/17"
);
...
<p>The ID of the transaction. Example: <code>17</code></p>
                ...
                <h1 id="transfer">Transfer</h1>
                                ...
                                <h2 id="transfer-POSTapi-transfer">Transfer money between users.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://star-test.test/api/transfer" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"receiver_id\": 2,
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="receiver_id"                data-endpoint="POSTapi-transfer"
               value="2"
               data-component="body">
    <br>
<p>The recipient's user ID. Example: <code>2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The transfer amount. Minimum 1. Example: <code>100.5</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="idempotency_key"                data-endpoint="POSTapi-transfer"
               value=""abc123""
               data-component="body">
    <br>
<p>A client site generated unique identifier (browser, mobile apps, backend generated) to prevent duplicate transactions. Example: <code>"abc123"</code></p>
        </div>
        </form>
